...
function th_preloader_settings_page() {
    ...
    <div class="wp-preloading-wrapper">
        ...
        <p class="external-lib">
            This plugin was inspired by the awesome preloaders from <a
                    href="http://tympanus.net/codrops/2014/04/25/freebie-flat-style-squared-preloaders/">Codrops</a> and
            <a href="http://pixelbuddha.net/freebie/flat-preloaders">Pixelbuddha</a>
        </p>
    </div>
	<?php
}